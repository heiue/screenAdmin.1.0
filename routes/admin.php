...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'permission:member.manage']], function () {
    ...
    //预约列表
    Route::group(['middleware' => 'permission:member.reservation'], function () {
        Route::get('reservation', 'MemberController@reservation')->name('admin.member.reservation');
    });
});
//消息管理
...
Route::group(['namespace' => 'Admin','prefix' => 'admin', 'middleware' => ['auth','permission:product.manage']],function () {
    //规格名称
    Route::group(['middleware' => 'permission:product.attrname'], function () {
        Route::get('product/attrname','ProductController@attrname')->name('admin.product.attrname');
        Route::get('product/attrname/data','ProductController@attrname_data')->name('admin.product.attrname_data');
        //添加
        Route::get('product/attrname/create', 'ProductController@attrname_create')->name('admin.product.attrname_create')->middleware('permission:product.attrname.create');
        Route::post('product/attrname/attrname/save', 'ProductController@attrname_save')->name('admin.product.attrname_save')->middleware('permission:product.attrname.create');
        //编辑
        Route::get('product/attrname/{id}/edit', 'ProductController@attrname_edit')->name('admin.product.attrname_edit')->middleware('permission:product.attrname.edit');
        Route::put('product/attrname/{id}/update', 'ProductController@attrname_update')->name('admin.product.attrname_update')->middleware('permission:product.attrname.edit');
        //删除
        Route::delete('product/attrname/destroy', 'ProductController@attrname_destroy')->name('admin.product.attrname_destroy')->middleware('permission:product.attrname.destroy');
    });

    //规格属性值
    Route::group(['middleware' => 'permission:product.attrvalue'],function () {
        Route::get('product/attrvalue','ProductController@attrvalue')->name('admin.product.attrvalue');
        Route::get('product/attrvalue/data','ProductController@attrvalue_data')->name('admin.product.attrvalue_data');

        //添加
        Route::get('product/attrvalue/create', 'ProductController@attrvalue_create')->name('admin.product.attrvalue_create')->middleware('permission:product.attrvalue.create');
        Route::post('product/attrvalue/attrvalue/save', 'ProductController@attrvalue_save')->name('admin.product.attrvalue_save')->middleware('permission:product.attrvalue.create');
        //编辑
        Route::get('product/attrvalue/{id}/edit', 'ProductController@attrvalue_edit')->name('admin.product.attrvalue_edit')->middleware('permission:product.attrvalue.edit');
        Route::put('product/attrvalue/{id}/update', 'ProductController@attrvalue_update')->name('admin.product.attrvalue_update')->middleware('permission:product.attrvalue.edit');
        //删除
        Route::delete('product/attrvalue/destroy', 'ProductController@attrvalue_destroy')->name('admin.product.attrvalue_destroy')->middleware('permission:product.attrvalue.destroy');

    });

    //商品分类
    Route::group(['middleware' => 'permission:product.cates'],function () {
        Route::get('product/cates','ProductController@cates')->name('admin.product.cates');
        Route::get('product/cates/data','ProductController@cates_data')->name('admin.product.cates_data');

        //添加
        Route::get('product/cates/create', 'ProductController@cates_create')->name('admin.product.cates_create')->middleware('permission:product.cates.create');
        Route::post('product/cates/save', 'ProductController@cates_save')->name('admin.product.cates_save')->middleware('permission:product.cates.create');

        //编辑
        Route::get('product/cates/{id}/edit','ProductController@cates_edit')->name('admin.product.cates_edit')->middleware('permission:product.cates.edit');
        Route::put('product/cates/{id}/update', 'ProductController@cates_update')->name('admin.product.cates_update')->middleware('permission:product.cates.edit');

        //删除
        Route::delete('product/cates/destroy', 'ProductController@cates_destroy')->name('admin.product.cates_destroy')->middleware('permission:product.cates.destroy');
